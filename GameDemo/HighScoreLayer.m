...
-(id) init
{
	...
	if( (self=[super init])) {
        ...
        CCSprite *bgSprite = [CCSprite spriteWithFile:@"HighScoreScene/bg.png"];
...
- (void) closeCallback: (id) sender {
	//NSLog(@"close pushed");
    [[CCDirector sharedDirector] replaceScene:[CCTransitionPageTurn transitionWithDuration:0.5f scene:[MainMenuLayer scene]]];
}
